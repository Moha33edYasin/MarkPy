...
Notes:
    ...
    * [2nd mark] is for any additional enclosed markers 
      you want to add.
    * [3rd and 4th marks] are optional enclosed tokens that 
      provide extra information for the HTML tag (such as links, images, etc.).
    * [key] is any html args that holds 3rd and 4th token.
    * Don't forget spearate your arguments with spaces.
      Example:
          # h (means '#Title' is a header of type 1)
          ** b ** (means '**text**' is a bold text)
          [ a ] ( ) href (means '[link name](url)' is a link)
